...
<div class="row-fluid">
    <div class="span12">
        ...
        <div class="portlet-title">
            <div class="caption"><i class="icon-reorder"></i>Add device</div>
            <div class="tools">
        ...
        <h3 class="form-section">Device information</h3>
        <div class="row-fluid">
            <div class="span6 ">
                <div class="control-group">
                    <label class="control-label">Device name</label>
                    <div class="controls">
                        <input type="text" name="deviceName" id="deviceName" placeholder="Login name" class="m-wrap span12">
                    </div>
                </div>
            </div>
            <!--/span-->
            <div class="span6 ">
                <div class="control-group">
                    ...
                    <div class="controls">
                        <input class="span12 m-wrap" name="deviceIp" id="deviceIp" type="text" maxlength="15" size="15">
                    </div>
                </div>
            </div>
        </div>
        <div class="row-fluid">
            ...
            <div class="span6 ">
                <div class="control-group">
                    ...
                    <div class="controls">
                        <input type="text" name="loginName" id="loginName" placeholder="Login name" class="m-wrap span12">
                    </div>
                </div>
            </div>
            <!--/span-->
            <div class="span6 ">
                <div class="control-group">
                    ...
                    <div class="controls">
                        <input type="text" name="loginPass" id="loginPass" placeholder="Login password" class="m-wrap span12">
                    </div>
                </div>
            </div>
            <!--/span-->
        ...
        <div class="row-fluid">
            ...
            <div class="span6 ">
                <div class="control-group">
                    ...
                    <div class="controls">
                        <input type="text" name="enablePass" id="enablePass" placeholder="Enable password" class="m-wrap span12">
                    </div>
                </div>
            </div>
            <!--/span-->
            ...
            <div class="span6 ">
                <div class="control-group">
                    ...
                    <div class="controls">
                        <input type="text" name="configPass" id="configPass" placeholder="Config password" class="m-wrap span12">
                    </div>
                </div>
            </div>
            <!--/span-->
        ...
        <div class="row-fluid">
            ...
            <div class="span12 ">
                <div class="control-group">
                    ...
                    <div class="controls">
                        <input type="text" name="deviceAddress" id="deviceAddress" placeholder="Device address" class="m-wrap span12">
                    </div>
                </div>
            </div>
        </div>
        <div class="row-fluid">
            ...
            <div class="span12 ">
                <div class="control-group">
                    ...
                    <div class="controls">
                        <input type="text" name="deviceInfo" id="deviceInfo" placeholder="Device info" class="m-wrap span12">
                    </div>
                </div>
            </div>
        </div>
        <div class="form-actions">
            <button type="button" onclick="addDevice()" class="btn blue"><i class="icon-ok"></i>Submit</button>
...
<script src="../resources/javascript/AddDevice.js" type="text/javascript"></script>
